...
function gerarXmlMock(data: IFormData, chaveAcesso: string): string {
  const now = new Date();
...
export function emitirNFSeMock(data: IFormData): INFSeResult {
...
export function statusServicoMock() {
  return {
    online: true,
    status: '107',
